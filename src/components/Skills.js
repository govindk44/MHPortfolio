  ...
  const skillCategories = {
    editing: {
      ...
      skills: [
        ...
        { name: 'Final Cut Pro', level: 60, years: '1+' },
        { name: 'DaVinci Resolve', level: 55, years: '1+' },
        { name: 'Avid Media Composer', level: 60, years: '1+' },
      ],
    },
    motion: {
      ...
      icon: '✨',
      skills: [
        { name: 'After Effects', level: 70, years: '1+' },
        { name: 'Cinema 4D', level: 60, years: '1+' },
